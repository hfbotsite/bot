"""platform_tables_v1
Revision ID: 614bc0284f34
Revises: 044833282c53
Create Date: 2026-03-07 22:29:42.031099
"""
...
revision: str = "614bc0284f34"
down_revision: Union[str, Sequence[str], None] = "044833282c53"
...
def upgrade() -> None:
    ...
    Breaking reset:
      ...
      - recreate platform tables

    This is intended for fresh/dev environments and for explicit platform cut-over.
    """
...
def downgrade() -> None:
    # Best-effort downgrade: drop created tables. In dev reset flows we recreate schema explicitly.
